...
const Loader = () => {
  return (
    <div className="flex items-center justify-center h-screen w-screen bg-bg-dark px-4">
      <div className="flex flex-col items-center relative">
        
        {/* Animated Car */}
        <div className="animate-car-drive mb-1">
          <svg
        ...
        {/* Road Line */}
        <hr className="border-gray-600 w-full max-w-xs  " />
        <hr className="border-gray-400 w-full max-w-xs  " />

        {/* Loading Text */}
        <div className="flex text-2xl font-semibold md:text-4xl tracking-[0.5em] text-blue-600 mt-2 select-none">
          Loading 
  <div className="flex space-x-2 mt-5 sm:mt-7">
